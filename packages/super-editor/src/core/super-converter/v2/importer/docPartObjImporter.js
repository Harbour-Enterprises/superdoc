...
export const handleDocPartObj = (nodes, docx, nodeListHandler, insideTrackChange, converter) => {
  ...
  const result = handler(content, docx, nodeListHandler, insideTrackChange, converter);
