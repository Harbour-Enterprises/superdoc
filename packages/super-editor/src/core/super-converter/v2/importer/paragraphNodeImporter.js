 ...
 */
export const handleParagraphNode = (nodes, docx, nodeListHandler, insideTrackChange, converter, filename) => {
  ...
  const result = handleStandardNode([node], docx, nodeListHandler, insideTrackChange, converter, filename);
