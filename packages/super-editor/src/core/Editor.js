...
export class Editor extends EventEmitter {
  ...
  #initDefaultStyles() {    
    ...
    const width = pageSize.width - pageMargins.left - pageMargins.right;
    const height = pageSize.height - pageMargins.top - pageMargins.bottom;
    ...
    this.element.style.padding = '1in';
